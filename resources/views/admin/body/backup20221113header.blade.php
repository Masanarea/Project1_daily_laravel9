<header id="page-topbar">
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <!-- キータ有料記事 -->
                        <!-- https://qiita.com/reflet/items/967edc2832c73bbf84e0 -->
                        <!-- これの裏をpreventdefaultとかで止めて、これと同じようなjqueryもしくはVue.jsのポップアップイベントボタンを作れるように調整できるかも... -->
                        <!-- 原理としてはおそらくjQueryで元々ボタンの下に書いてあったHTML（デフォルトでは非表示）にボタンを押したらshowクラスとwidthとかheightをそのままはっつける感じ -->
                        <!-- aria-expanded="true"で表示するかしないかを決めて、 -->
                        <!-- <button type="button" class="btn header-item waves-effect show" data-bs-toggle="dropdown" aria-haspopup="false" aria-expanded="true">Mega Menu<i class="mdi mdi-chevron-down"></i></button> -->
                        <!-- 押されたら、style="" data-popper-placement=""から、style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(40px, 72px, 0px);" data-popper-placement="bottom-start"をつける -->
                        <!-- <div class="dropdown-menu dropdown-megamenu show" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(40px, 72px, 0px);" data-popper-placement="bottom-start">
                                <div class="row">
                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div>
                                                    <img src="http://127.0.0.1:8000/backend/assets/images/megamenu-img.png" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
